				...
				<div class="item">
					<li class="catgry d-flex justify-content-center align-items-center w-95 p-3 mx-3">
					  <a class="text-decoration-none" data-toggle="tab" href="#{{ $srr_na}}">
					    <img src="{{ env('DESKTOP_APP_URL') }}/assets/images/new/{{$speciali->speciality_image}}.svg" style="max-height: 60px;max-width: 60px;margin: 0 auto;">
								...
								<div class="doctor-box-fot"> 
									<div class="row">										
										...
										@endphp
											...
											<button class="doctor-box-fot-txt btn doctors-view-btn btn-popup" data-bs-target="#askAquery" data-id="{{$askAquery}}"><span><img src="{{ url('assets/images/icons/envelopeicn.svg') }}"></span> ASK A QUERY</button>
										</div>
										<div class="col-7">
						...
						<div class="col-lg-12">          
							<div class="doctor-box">    
								...
								<div class="col-5">											
									...
									$ff_file = "storage/app/public/uploads/".$s_doctor->file;
									@endphp
									<img src="{{ env('DESKTOP_APP_URL')}}/{{ $ff_file }}">									
									</div> 
								</div>
								<div class="col-7 d-a-d-p">     
								<div class="ten-yrs-exp">      
								...
								<div class="doctor-box-fot"> 
									...
									@endphp
										<div class="col-5 bor-right">
											<!-- <a data-bs-toggle="modal" data-bs-target="#askAquery"><div class="doctor-box-fot-txt"><span><img src="{{ url('assets/images/icons/envelopeicn.svg') }}"></span>Ask a query</div>	</a> -->
											<button class="doctor-box-fot-txt btn doctors-view-btn btn-popup" data-id="{{$askAquery}}"><span><img src="{{ url('assets/images/icons/envelopeicn.svg') }}"></span> ASK A QUERY</button> <!--  //Rs.{{$s_doctor->Ask_A_query_Fee}}/- -->
										</div>
										<div class="col-7">
											<a href="{{ url($vv_url) }}"><div class="doctor-box-fot-txt"><span><img src="{{ url('assets/images/icons/Videoicn.svg') }}"></span>Consult on Video</div></a>										
										</div>		 									
